...
class HasPermissionsTest extends TestCase
{
    ...
    public function it_can_scope_users_using_a_string()
    {
        ...
        $scopedUsers1 = User::havingPermission('edit-articles')->get();
        $scopedUsers2 = User::havingPermission('edit-news')->get();
    ...
    public function it_can_scope_users_using_an_object()
    {
        ...
        $scopedUsers1 = User::havingPermission($this->testUserPermission)->get();
    ...
    public function it_can_scope_users_without_permissions_only_role()
    {
        ...
        $scopedUsers = User::havingPermission('edit-articles')->get();
    ...
    public function it_can_scope_users_without_permissions_only_permission()
    {
        ...
        $scopedUsers = User::havingPermission('edit-news')->get();
    ...
    public function it_throws_an_exception_when_trying_to_scope_a_permission_from_another_guard()
    {
        ...
        User::havingPermission('testAdminPermission')->get();

        $this->expectException(GuardDoesNotMatch::class);

        User::havingPermission($this->testAdminPermission)->get();
    }
